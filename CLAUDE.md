...
- EQ Mob KB: `mob_*` tables, `/api/mobs`, eq roles in `user_roles`. Loot links to `eq_items` via `mob_loot.equipment_id`; shared item modal + KYA name-match jumps. [docs/mobs.md](docs/mobs.md), [docs/linking-plan.md](docs/linking-plan.md).
